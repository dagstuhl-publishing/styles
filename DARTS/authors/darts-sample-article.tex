...
%% Please provide for each author the \author and \affil macro, even when authors have the same affiliation, i.e. for each author there needs to be the  \author and \affil macros (ORCIDs are optional but highly recommended; for registration, please visit https://orcid.org/register)
\author[1]{John Q. Open}
\author[2]{Joan R. Access}
\affil[1]{Dummy University Computing Laboratory, Address/City, Country\\
  \orcid{xxx}\\
  \email{open@dummyuniversity.org}}
\affil[2]{Department of Informatics, Dummy College, Address/City, Country\\
  \orcid{yyy}\\
  \email{access@dummycollege.org}}
