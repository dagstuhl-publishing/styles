...
\author{John Q. Open}{Dummy University Computing Laboratory\\{[Address, Country]}}{johnqpublic@dummyuni.org}{[orcid]}{[funding]}%mandatory, please use full name; only 1 author per \author macro; first two parameters are mandatory, other parameters can be empty.
...
\bibliography{darts-sample-article}
