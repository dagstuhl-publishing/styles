...
%This is a template for producing a frontmatter of a LITES issue.
%The usage of this file together with litesmaster-v2021.cls should be
%straightforward. There is no separate documentation.
%Feel free to adapt this file or lipicsmaster.cls if required.

\documentclass[a4paper,UKenglish]{litesmaster-v2021}
