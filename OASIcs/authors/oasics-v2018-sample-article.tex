...
\documentclass[a4paper,UKenglish]{oasics-v2018}
...
\Copyright{John Q. Public and Joan R. Public}%mandatory, please use full first names. OASIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\item Do not alter the spacing of the  \verb+oasics-v2018.cls+ style file. Such modifications will be removed.
...
\item Keep the standard style (\verb+plainurl+) for the bibliography as provided by the\linebreak \verb+oasics-v2018.cls+ style file.
...
\item A manual for the OASIcs style is available at \url{http://drops.dagstuhl.de/styles/oasics-v2018/oasics-v2018-authors/oasics-v2018-manual.pdf}.
\end{itemize}
...
\bibliography{oasics-v2018-sample-article}
