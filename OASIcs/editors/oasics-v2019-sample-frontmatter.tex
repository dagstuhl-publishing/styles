...
%The usage of this file together with oasicsmaster-v2019.cls should be
%straightforward. There is no separate documentation.

\documentclass[a4paper,UKenglish]{oasicsmaster-v2019}
...
%TODO please enter macros as provided by OASics office%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ISBN{424-2-424242-424-2}%TODO mandatory: Please enter ISBN as provided by OASics office

%\DatePublished{June 6, 2018}%leave empty; will be entered by OASics office before publication
...
%\titlepagebottomline{OASics -- Vol.~\printSeriesVolume{} -- \printEventShortTitle \qquad \qquad \qquad www.dagstuhl.de/oasics} %override text line in the yellow box on the titlepage
...
{\Large\bf\sffamily \href{https://www.dagstuhl.de/dagpub/\printISBN}{ISBN \printISBN}}
...
\emph{License}\newline
This work is licensed under a Creative Commons Attribution 3.0 Unported license (CC-BY~3.0):\\ \href{https://creativecommons.org/licenses/by/3.0/legalcode}{https://creativecommons.org/licenses/by/3.0/legalcode}.\\
...
\vfill
\textbf{\href{https://www.dagstuhl.de/dagpub/\printISBN}{ISBN \printISBN}}\qquad \qquad \textbf{\href{https://www.dagstuhl.de/dagpub/2190-6807}{ISSN 2190-6807}}  \hfill \textbf{\href{https://www.dagstuhl.de/oasics}{https://www.dagstuhl.de/oasics}}
...
%OASIcs Board members as of June 2018
\begin{itemize}
...
{\large\bf\sffamily \href{https://www.dagstuhl.de/dagpub/2190-6807}{ISSN 2190-6807}}

\bigskip
\bigskip
\bigskip

{\Large\bf\sffamily \href{https://www.dagstuhl.de/oasics}{https://www.dagstuhl.de/oasics}}
...
%Please note, that the table of contents will be generated by the OASics office based on the order provided in the Dagstuhl Submission System. So you can keep this section as is!!!
...
\inputtocentry{oasics-v2019-sample-article}
